---
name: verify-change
description: Verify a code change through repository-defined risk routing,
  deterministic tests, Kimi WebBridge browser acceptance, AI/data evaluation,
  independent review, and a fresh verification receipt. Use after implementing
  or fixing behavior, before reporting completion, before a commit/PR, or
  whenever verification-policy.json requires evidence for the current diff.
disable: false
---
